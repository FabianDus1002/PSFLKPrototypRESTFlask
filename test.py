...
response = requests.delete(BASE + "friedhofstandort/Friedhof H1", timeout=5)
print(response.json())
input()
response =requests.get(BASE  + "friedhofstandort/Friedhof Kinderhaus", timeout=5)
print(response.json())

input()
response = requests.post(BASE  + "friedhofstandort/Friedhof H1",
{"NAME":"Friedhof H1", "RECHTSWERT":1, "HOCHWERT":"2", "HOMEPAGE":"example.com"}, timeout=5)
print(response.json())

input()
response = requests.put(BASE  + "friedhofstandort/Friedhof H1",
 {"NAME":"Friedhof H1", "RECHTSWERT":2, "HOCHWERT":3, "HOMEPAGE":"example.com"}, timeout=5)
print(response.json())

input()
response = requests.patch(BASE  + "friedhofstandort/Friedhof H1", {"HOCHWERT":34}, timeout=5)
print(response.json())
